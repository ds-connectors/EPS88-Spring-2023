...
| --- | --- | --- | --- |
| Week 1 : Jan 23 | What is your birthquake? | Introduction to accessing data within the Jupyter notebook environment. | *Accessing data through the USGS API within a Jupyter notebook* Use Python code within a Jupyter notebook to access an online API to pull in and inspect tabular data. |
| Week 1 assignment | Maps | Develop an understanding of map projections and visualizations of geospatial data. | Learn to generate maps in `cartopy` and to plot locations. |
