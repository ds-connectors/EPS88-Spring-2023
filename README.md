...
| Week 2 assignment | Seafloor age and plate tectonics | Use global seafloor age distribution to make inferences about plate tectonic processes. | *Data wrangling and visualization.* Get further introduced to the `pandas` library. Use the `matplotlib` and `cartopy` functions to visualize geospatial data in order to identify patterns. |
